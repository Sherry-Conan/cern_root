...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   virtual Int_t    Check(Double_t *p); 
   virtual void     SetBranch(TTree *Data); 
   virtual void     aTrace(TH2D *h, Double_t k, Double_t b, Int_t max = 0, Int_t min = -1800); 
   virtual Bool_t   calculate(TH2D *hForzx, Int_t k, Double_t *p, Double_t *pz, Double_t *pdx, Double_t *pFitxb, Double_t *pFitxk, Double_t *pchix, Double_t *pndfx); 
};
